...
const inputCls =
  'h-12 w-full rounded-lg border border-[hsl(var(--border))] bg-background px-3.5 pl-11 pr-11 text-sm font-medium text-foreground outline-none transition-all placeholder:text-[hsl(var(--foreground-soft)/0.45)] focus:border-[hsl(var(--primary)/0.5)] focus:ring-2 focus:ring-[hsl(var(--primary)/0.08)]'
    ...
    >
      <form onSubmit={handleSubmit} className="rounded-xl border border-[hsl(var(--border))] bg-card p-5 sm:p-6">
        ...
        <button
          ...
          className="mt-6 flex h-11 w-full items-center justify-center gap-2 rounded-md bg-[hsl(var(--primary))] px-5 text-sm font-semibold text-white transition-colors hover:bg-[hsl(243_90%_58%)] disabled:cursor-not-allowed disabled:opacity-60"
        >
