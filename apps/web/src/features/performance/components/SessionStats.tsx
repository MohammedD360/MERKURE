...
export function SessionStats({ period, accountId }: Props) {
  ...
  return (
    <div className="rounded-lg border border-border bg-background p-4 shadow-[0_14px_46px_rgba(0,0,0,0.18)]">
      <h2 className="mb-4 text-sm font-semibold text-foreground">Performance par session</h2>
      ...
      {query.isLoading ? <Skeleton /> : data.length === 0 ? (
        ...
        <ResponsiveContainer width="100%" height={200}>
          ...
          >
            ...
            <Bar dataKey="nbTrades" name="Trades" fill="hsl(var(--muted-foreground))" radius={[0, 3, 3, 0]} barSize={8} />
