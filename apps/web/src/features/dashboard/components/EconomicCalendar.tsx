...
export function EconomicCalendar() {
  return (
    <div className="flex flex-col rounded-lg border border-border bg-background p-5 shadow-[0_14px_40px_rgba(0,0,0,0.18)] lg:p-6">
      ...
      <div className="flex min-h-32 flex-1 flex-col items-center justify-center gap-3 rounded-lg border border-dashed border-border bg-[#071017] px-4 py-8 text-center">
