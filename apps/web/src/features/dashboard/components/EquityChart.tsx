...
function CustomTooltip({ active, payload, label }: any) {
  ...
  return (
    <div className="bg-gray-800 border border-gray-700 rounded-lg px-3 py-2 text-xs shadow-xl">
      ...
      <div className="font-semibold text-white">Performance : <span className="text-indigo-400">+{val.toFixed(2)}%</span></div>
    </div>
  )
}
  ...
  return (
    <div className="bg-[#111827] border border-gray-800/60 rounded-xl p-5">
      ...
      <ResponsiveContainer width="100%" height={200}>
        <AreaChart data={mockEquityCurve} margin={{ top: 4, right: 4, bottom: 0, left: -10 }}>
          <defs>
