    ...
    <div className="min-h-screen bg-background px-4 py-5 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl space-y-5">
        <section className="rounded-lg border border-border bg-card p-6 shadow-sm">
          ...
          <div className="mt-6 inline-flex rounded-md border border-amber-500/30 bg-amber-500/10 px-3 py-1.5 text-xs font-bold text-amber-400">
            {status}
          </div>
        </section>
        ...
        <section className="rounded-lg border border-border bg-card p-6 shadow-sm">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            {items.map((item) => (
              <div key={item} className="flex items-start gap-3 rounded-md border border-border bg-muted p-3">
          ...
          {primaryAction && (
            <Link
              ...
              className="mt-5 inline-flex items-center gap-2 rounded-md bg-[hsl(var(--primary))] px-4 py-2.5 text-sm font-bold text-white transition-colors hover:bg-[hsl(243_90%_58%)]"
            >
              {primaryAction.label}
