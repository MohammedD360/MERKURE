  ...
  challenges: [
    {
      ...
      hiddenRules: [
        ...
        {
          id: 'apex-pa-consistency',
          title: 'Règle de consistance à 30%',
          description: "Aucune journée de trading ne doit représenter plus de 30% du profit total réalisé sur le compte.",
          trap: "Un jour exceptionnellement profitable qui dépasse ce seuil bloque le passage au compte financé, même si l'objectif de profit est techniquement atteint.",
          consequence: 'Passage en compte financé refusé tant que la règle de consistance à 30% n’est pas respectée.',
          severity: 'important',
          metric: 'consistency',
          threshold: 30,
        },
      ...
      sizes: [
        { value: 25_000,  label: '$25,000',  fee: 127, profitSplit: 90 },
      ...
      hiddenRules: [
        {
          ...
          title: 'Règle de consistance à 30%',
          description: "Aucune journée de trading ne doit représenter plus de 30% du profit total réalisé sur le compte.",
          trap: "Réussir l'objectif en un ou deux trades exceptionnels peut faire dépasser ce seuil et retarder ou compliquer l'activation du compte financé.",
          consequence: 'Passage en compte financé refusé ou retardé tant que la règle de consistance à 30% n’est pas respectée.',
          severity: 'important',
          metric: 'consistency',
          threshold: 30,
        },
