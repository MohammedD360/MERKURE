...
export function TradeDetailModal({ tradeId, onClose }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-card border border-[hsl(var(--border))] rounded-2xl w-full max-w-lg shadow-2xl">
        {/* Header */}
            ...
            {trade && (
              <>
                ...
                <div>
                  ...
                  <div className={`inline-flex items-center gap-1 text-xs font-medium mt-0.5 ${direction === 'LONG' ? 'text-green-500' : 'text-red-500'}`}>
            ...
            <>
              ...
              <div className="bg-[hsl(var(--accent))] rounded-xl p-4">
                ...
                <Row label="Statut"      value={
                  <span className={`px-1.5 py-0.5 rounded text-xs font-medium ${trade.status === 'OPEN' ? 'bg-[hsl(var(--primary)/0.1)] text-[hsl(var(--primary))] border border-[hsl(var(--primary)/0.25)]' : 'bg-[hsl(var(--accent))] text-[hsl(var(--foreground-soft))] border border-[hsl(var(--border))]'}`}>
              ...
              <div className="space-y-3">
                <div>
                  <label className="flex items-center gap-1.5 text-xs font-semibold text-[hsl(var(--foreground-soft))] mb-1.5">
                  ...
                  <input
                    ...
                    maxLength={100}
                    className="w-full bg-card border border-[hsl(var(--border))] rounded-lg px-3 py-2 text-xs text-foreground placeholder-[hsl(var(--foreground-soft))]/50 focus:outline-none focus:border-[hsl(var(--primary))]"
                  />
                </div>
                <div>
                  <label className="flex items-center gap-1.5 text-xs font-semibold text-[hsl(var(--foreground-soft))] mb-1.5">
                  ...
                  <textarea
                    ...
                    maxLength={2000}
                    rows={3}
                    className="w-full bg-card border border-[hsl(var(--border))] rounded-lg px-3 py-2 text-xs text-foreground placeholder-[hsl(var(--foreground-soft))]/50 focus:outline-none focus:border-[hsl(var(--primary))] resize-none"
                  />
                </div>
              </div>
            </>
          ...
          {trade && (
            confirmDelete ? (
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs text-red-400 hover:text-red-500 hover:bg-red-500/10 transition-colors"
              >
