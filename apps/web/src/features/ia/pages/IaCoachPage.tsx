    ...
    <div className="space-y-6 px-4 py-5 sm:px-6 lg:px-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h1 className="text-base font-semibold text-foreground">Coach de discipline</h1>
        ...
        <button
          ...
          disabled={isPending}
          className="inline-flex shrink-0 items-center justify-center gap-2 rounded-lg border border-[hsl(var(--primary)/0.25)] bg-[hsl(var(--primary)/0.08)] px-4 py-2 text-xs font-semibold text-[hsl(var(--primary))] transition hover:bg-[hsl(var(--primary)/0.15)] disabled:opacity-50"
        >
      ...
      <div className="grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
        <section className="rounded-xl border border-[hsl(var(--border))] bg-card p-5">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-sm font-semibold text-foreground">Signal prioritaire</p>
              ...
              <ul className="space-y-3">
                {actions.slice(0, 4).map((action, index) => (
                  <li key={action} className="flex items-start gap-3 text-xs leading-5 text-muted-foreground">
                    <span className="mt-0.5 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-amber-500/10 text-xs font-semibold text-amber-500">
                      {index + 1}
                    </span>
                    {action}
                  </li>
        ...
        <section className="rounded-xl border border-[hsl(var(--border))] bg-card p-5">
          <p className="text-sm font-semibold text-foreground">Cadre recommandé</p>
