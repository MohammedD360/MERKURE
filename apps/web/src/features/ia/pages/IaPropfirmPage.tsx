...
const compatibilityCards: Array<{
  ...
  },
  {
    ...
    tone:    'border-blue-400/25 bg-blue-400/[0.08] text-blue-300',
  },
]
...
function PropFirmVisual() {
  return (
    <div className="relative hidden min-h-[250px] overflow-hidden lg:block">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_70%_34%,rgba(86,191,107,0.22),transparent_30%),radial-gradient(circle_at_38%_78%,rgba(124,92,255,0.16),transparent_28%)]" />
      <div className="absolute right-8 top-7 w-[360px] rounded-xl border border-white/10 bg-[#10182f]/80 p-5 shadow-[0_24px_80px_rgba(0,0,0,0.30)]">
        ...
        <div className="mt-5 space-y-3">
          {[
            ['Drawdown', 'Respecté', 'text-emerald-300'],
            ['Risque / trade', 'Stable', 'text-emerald-300'],
            ['Objectif', 'Réaliste', 'text-blue-300'],
      ...
      <div className="absolute bottom-8 right-16 h-px w-[450px] bg-gradient-to-r from-transparent via-emerald-400/35 to-transparent" />
    </div>
  )
}
      ...
      <section className="overflow-hidden rounded-xl border border-white/10 bg-[#0b111c] shadow-[0_12px_52px_rgba(0,0,0,0.22)]">
        <div className="relative grid lg:grid-cols-[1fr_0.92fr]">
          ...
          <div className="relative px-7 py-8">
            <span className="rounded-md border border-[#56bf6b]/20 bg-[#56bf6b]/[0.08] px-3 py-1 text-[10px] font-black uppercase tracking-[0.18em] text-[#56bf6b]">
              Prop firms
            </span>
            ...
            <div className="mt-6 flex flex-wrap gap-x-8 gap-y-3 text-xs font-semibold text-slate-400">
              {[
                ...
                <span key={label} className="flex items-center gap-2">
                  <Icon className="h-4 w-4 text-[#56bf6b]" />
                  {label}
                </span>
              ))}
            </div>
        ...
        <article className="rounded-xl border border-white/10 bg-[#0b111c] p-5">
          ...
          <div className="mt-4 grid gap-3 sm:grid-cols-2">
            {actionPlan.map((item, index) => (
              <div key={item} className="flex items-start gap-3 rounded-lg border border-white/[0.06] bg-[#071017] px-4 py-3">
