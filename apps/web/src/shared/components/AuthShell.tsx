...
function ProductPanel() {
  return (
    <aside className="relative hidden h-full flex-col bg-[#060c14] p-10 text-white lg:flex" style={{ borderRight: '1px solid rgba(255,255,255,0.08)' }}>
      {/* Glow accents */}
      <div className="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden>
        <div className="absolute -left-32 top-1/4 h-[480px] w-[480px] rounded-full bg-blue-600/[0.07] blur-[120px]" />
        <div className="absolute -right-16 bottom-1/3 h-[360px] w-[360px] rounded-full bg-emerald-600/[0.05] blur-[100px]" />
      </div>
      ...
      {/* Main content */}
      <div className="relative z-20 mt-10 flex flex-1 flex-col justify-center overflow-y-auto">
...
export function AuthShell({ eyebrow, title, description, children }: AuthShellProps) {
  return (
    <div className="flex relative min-h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0 bg-[#070b10] text-white">
      {/* Background glows (visible on mobile / behind form) */}
      <div className="pointer-events-none fixed inset-0 overflow-hidden lg:hidden" aria-hidden>
        <div className="absolute -left-32 top-1/4 h-[480px] w-[480px] rounded-full bg-blue-600/[0.07] blur-[120px]" />
      ...
      <div className="relative p-4 lg:p-8">
        {/* Mobile logo (hidden on desktop where ProductPanel shows it) */}
        ...
        <div className="mx-auto flex w-full flex-col justify-center space-y-6 sm:w-[480px]">
          <div className="flex flex-col space-y-2 text-center">
            <span className="mx-auto inline-flex rounded-full border border-blue-400/20 bg-blue-400/[0.08] px-3.5 py-1.5 text-[11px] font-black uppercase tracking-[0.18em] text-blue-300">
              {eyebrow}
            </span>
          ...
          <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 border-t border-white/10 pt-5 text-xs font-semibold text-slate-500">
